...
Version  : 1.6.1
Release  : 5
URL      : https://cran.r-project.org/src/contrib/conting_1.6.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/conting_1.6.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530310594
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library conting|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
